...
class ActasSeeder extends Seeder
{
    ...
    public function run(): void
    {
        ...
        $actas = [
            ...
            ['incidencia' => 'tarjetas', 'hora' => '12:15:00', 'comentario' => 'Tarjeta amarilla por falta fuerte.', 'partido_id' => $partidos->get(3)->id, 'jugador_id' => $jugadores->get(14)->id],
            ...
            ['incidencia' => 'tarjetas', 'hora' => '12:35:00', 'comentario' => 'Segunda amarilla, expulsión del jugador.', 'partido_id' => $partidos->get(2)->id, 'jugador_id' => $jugadores->get(11)->id],
            ...
            ['incidencia' => 'tarjetas', 'hora' => '12:55:00', 'comentario' => 'Falta en el área, penal y amarilla.', 'partido_id' => $partidos->get(2)->id, 'jugador_id' => $jugadores->get(18)->id],
            ...
            ['incidencia' => 'tarjetas', 'hora' => '13:15:00', 'comentario' => 'Tarjeta roja por entrada peligrosa.', 'partido_id' => $partidos->get(1)->id, 'jugador_id' => $jugadores->get(15)->id],
